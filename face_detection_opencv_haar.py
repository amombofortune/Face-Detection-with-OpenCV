...
#Detect faces
#The cv2.CascadeClassifier.detectMultiScale() function detects objects and returns them as a list of rectangles.
...
retval, faces_haar_alt2 = cv2.face.getFacesHAAR(img, "haarcascade_frontalface_default.xml")
...
#plot the images
show_img_with_matplotlib(img_faces_alt2, "Frontalface_alt2): ", 1)
show_img_with_matplotlib(img_faces_default, "Frontalface_default): ", 2)
