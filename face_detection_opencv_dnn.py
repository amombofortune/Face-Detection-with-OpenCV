...
#Load image
image = cv2.imread("id_sample.png")

#Get dimensions of the input image
(h, w) = image.shape[:2]

#Create 4-dimensional blob from image
#To achieve the best accuracy, we must run the model on BGR images resized to 300 x 300 by applying 
# mean subtraction of values of (104, 177, 123) for the blue, green, and red channels, respectively
